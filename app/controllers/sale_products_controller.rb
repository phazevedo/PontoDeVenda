class SaleProductsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sale_product.save
        format.html { redirect_to @sale_product, notice: 'Product sale was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @sale_product.update(sale_product_params)
        format.html { redirect_to @sale_product, notice: 'Product sale was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sale_products_url, notice: 'Product sale was successfully destroyed.' }
  ...
  private
    ...
    def sale_product_params
      params.require(:sale_product).permit(:product_id, :qty, :value)
    end
end
